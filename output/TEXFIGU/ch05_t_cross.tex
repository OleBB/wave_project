...
%   plot_type         : t_cross
%   data_class        : DELEG
%   generated_at      : 2026-04-24T15:31:01
%   findings_doc      : analysis_scratch/t_cross_figure_findings.md
%
% — Thesis context ──────────────────────────────────────────────
%   chapter           : 05
%   caption_label     : fig:ch05_t_cross
%   caption_short     : Wind effect on transmission measured three ways: $(OUT/IN)_{nw}$ (blue, nowind baseline); $T_{\mathrm{cross}} = A_{out}^{fw}/A_{in}^{nw}$ (green, fullwind OUT referenced to the clean nowind IN); an…
%
% — Filters ────────────────────────────────────────────────────
%   panel             : full
%   wind              : no, full
