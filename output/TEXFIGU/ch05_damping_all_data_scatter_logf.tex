...
%   data_class        : DELEG
%   generated_at      : 2026-05-08T15:19:22
%   findings_doc      : 
%
% — Thesis context ──────────────────────────────────────────────
%   chapter           : 05
%   caption_label     : fig:ch05_damping_all_data_scatter_logf
%   caption_short     : 
%
% — Filters ────────────────────────────────────────────────────
%   panel             : full
...
%     FIGURES/ch05_damping_all_data_scatter_logf.pdf
% ── end immutable block ─────────────────────────────────────────
\begin{figure}[htbp]
  \centering
  \thispagestyle{empty}
  \includegraphics[width=\linewidth]{FIGURES/ch05_damping_all_data_scatter_logf.pdf}
  \caption{
    % TODO: write caption
  }
  \label{fig:ch05_damping_all_data_scatter_logf}
\end{figure}
