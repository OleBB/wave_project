...
%   data_class        : DELEG
%   generated_at      : 2026-05-06T11:35:12
%   findings_doc      : 
%
% — Thesis context ──────────────────────────────────────────────
%   chapter           : 05
...
\begin{figure}[p]
  ...
  \caption[Mooring + panelretning ved 1.30 Hz.]{
    TODO: skriv hovedteksten. Sammenligning av transmisjon $K_t$ ved 1.30 Hz på tvers av mooring (below\_90 vs above\_50) og panelretning (normal vs revers), for hver av amplitudevalgene $A_1$, $A_2$, $A_3$. Fyrer (hule) markører for å se overlappende punkter.
  }
