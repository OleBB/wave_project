...
%   caption_short     : Pulesammendrag av $K_t$ mot $ka$/$kL$ — alle konfigurasjoner.
%
% — Method ─────────────────────────────────────────────────────
...
\begin{table}[htbp]
  ...
  \begin{tabular}{ccccccc}
    ...
    \bottomrule
  \end{tabular}
  \caption[Pulesammendrag av $K_t$ mot $ka$/$kL$ — alle konfigurasjoner.]{
    Tall til figur \ref{fig:ch05_damping_all_data_scatter_ka}. Hver rad puljer kjøringer på (konfigurasjon $\times$ amplitude $\times$ vind). Kolonner: $n$ er antall kjøringer, $ka$- og $kL$-spennet pulen dekker, $\bar{K_t} \pm \sigma$, og lokalt stigningstall fra lineær tilpasning av $K_t$ mot $ka$ og $kL$ innen pulen ($L = 2{,}6$~m).
  }
