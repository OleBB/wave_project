...
PROBE_CONFIGS = [
    ProbeConfiguration(
        ...
        notes="Original configuration used until Nov 13, 2025"
    ),
    ProbeConfiguration(
        ...
        notes="Configuration after Nov 14 adjustment. TODO: Get actual values!"
    ),
    ...
    #         4: 12601.0,
    #     },
    #     notes="Recalibrated after tank maintenance"
    # ),
]
...
MOORING_CONFIGS = [
    MooringConfiguration(
        ...
        mooring_type="high",
        notes="Original high mooring setup"
    ),
    MooringConfiguration(
        name="low_mooring",
        ...
        valid_until=None,
        mooring_type="low",
        notes="Switched to low mooring on Nov 6"
    ),
]
