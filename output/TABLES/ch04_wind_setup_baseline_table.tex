...
%   chapter           : 04
%   generated_at      : 2026-05-08T12:09:27
...
\begin{table}[hbt]
  \centering
  \caption{
    Målt endring i vannstand ved å se på utgående probe. Fire datasett.
  }
  ...
  \begin{tabular}{l l c c c c}
    ...
    \midrule
    \multicolumn{6}{l}{\itshape 20260323  (Moring 9-23 / highrange)} \\
     & av $\rightarrow$ på & \num{100.263} & \num{99.063} & \num{1.200} & 3/3 \\
     & på $\rightarrow$ av & \num{100.617} & \num{99.047} & \num{1.570} & 3/3 \\
     & av $\rightarrow$ på & \num{100.657} & \num{99.523} & \num{1.133} & 3/3 \\
    ...
    \midrule
    \multicolumn{6}{l}{\itshape 20260324  (Moring 9-23 / highrange)} \\
    ...
    \midrule
    \multicolumn{6}{l}{\itshape 20260326  (Moring 9-23 / lowrange)} \\
    ...
    & \textit{snitt (n=}4\textit{)} & — & — & \num{0.884} & — \\
    \midrule
    \multicolumn{6}{l}{\itshape 20260327  (Moring 9-30 / lowrange)} \\
     & av $\rightarrow$ på & \num{100.713} & \num{99.500} & \num{1.213} & 3/3 \\
     & på $\rightarrow$ av & \num{101.200} & \num{99.937} & \num{1.263} & 3/3 \\
     & av $\rightarrow$ på & \num{101.383} & \num{99.977} & \num{1.407} & 3/3 \\
