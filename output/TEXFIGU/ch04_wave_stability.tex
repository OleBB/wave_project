...
%   data_class        : 
%   generated_at      : 2026-04-22T19:46:05
%   findings_doc      : 
%
% — Thesis context ──────────────────────────────────────────────
%   chapter           : 04
%   caption_label     : fig:ch04_wave_stability
%   caption_short     : Wave-train stability (autocorrelation at lag-1-period) versus wave frequency for 4 probes, 292 wave runs
%
% — Filters ────────────────────────────────────────────────────
%   panel             : full
%   wind              : 
...
\begin{figure}[htbp]
  ...
  \caption[Wave-train stability (autocorrelation at lag-1-period) versus wave frequency for 4 probes, 292 wave runs]{
    Wave-train stability (autocorrelation at lag-1-period) versus wave frequency for 4 probes, 292 wave runs. Colour = wind condition; linestyle = wave amplitude. Error bars: standard deviation across repeated runs at the same (frequency, amplitude). Dashed line: quality threshold 0.85 — runs below this are dominated by wind-wave noise at the IN probe.
  }
