...
%   data_class        : DFS
%   generated_at      : 2026-05-10T22:47:25
%   findings_doc      : 
%
% — Thesis context ──────────────────────────────────────────────
%   chapter           : 04
%   caption_label     : fig:ch04_plateau_overview_A3
%   caption_short     : Platå, A3
%
% — Filters ────────────────────────────────────────────────────
%   panel             : full
%   wind              : no, full
...
% >>> CAPTION-SYNC START (do not edit this block; sync_captions.py overwrites)
  \caption[Platå, A3]{
    Glidende gjennomsnitt av amplitude. $A_3$. Innkommende til venstre, utgående til høyre. Vertikale linjer indikerer estimerte tider for andre effekter.
  }
% <<< CAPTION-SYNC END
