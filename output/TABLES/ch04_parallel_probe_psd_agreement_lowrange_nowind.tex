...
%   chapter           : 04
%   generated_at      : 2026-05-06T22:13:04
%   caption_label     : tab:ch04_parallel_probe_psd_agreement_lowrange_nowind
%   caption_short     : 
%
% — Method ────────────────────────────────────────────────────
...
%
% — Inputs ────────────────────────────────────────────────────
%   N runs per freq   : 1.3Hz:n=32, 1.4Hz:n=32, 1.5Hz:n=32, 1.6Hz:n=32  (panel-full, quality-ok, both probes)
%   wind condition    : nowind
%   probe-range setup : lowrange
%   data scope        : low-range hardware, 100mm above; under9Mooring + under9Mooring30 (Mar 26+27 2026); WindCondition=no
...
\begin{table}[hbt]
  ...
  \label{tab:ch04_parallel_probe_psd_agreement_lowrange_nowind}
  \begin{tabular}{ccccc}
    \toprule
