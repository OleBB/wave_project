...
%   data_class        : 
%   generated_at      : 2026-04-30T14:42:42
%   findings_doc      : 
%
% — Thesis context ──────────────────────────────────────────────
%   chapter           : 04
...
\begin{figure}[htbp]
  ...
  \caption{
    Hovedmoden fra bølge \qty{1.4}{\hertz}, amplitudevalg $A_2$, resten av signalet er separert ut. Stablet ovenfra og ned: Innkommende uten vind, Utgående uten vind, Innkommende med vind, Utgående med vind. Felles y-akse for alle fire paneler.
  }
