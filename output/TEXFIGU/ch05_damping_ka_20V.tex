...
%   computed_in       : analysis_scratch/damping_ka_per_volt.py (single-voltage scatter, 20V)
...
% — Thesis context ──────────────────────────────────────────────
%   chapter           : 05
%   caption_label     : fig:ch05_damping_ka_20V
%   caption_short     : 
%
% — Filters ────────────────────────────────────────────────────
%   panel             : full
...
%     FIGURES/ch05_damping_ka_20V.pdf
% ── end immutable block ─────────────────────────────────────────
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.9\linewidth]{FIGURES/ch05_damping_ka_20V.pdf}
  \caption[Short caption for LOF]{
    % TODO: write caption
  }
  \label{fig:ch05_damping_ka_20V}
\end{figure}
