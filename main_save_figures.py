...
CHAPTER 05 — RESULTS
  ...
  §1b   ch05_damping_freq_table          [DELEG] ✓     └─ companion table: per-amp τ_nw / τ_fw / Δτ across 1.3–1.6 Hz
...
FIGURE_CAPTIONS: dict[str, str] = {
    ...
    "ch05_damping_freq_table":         "",   # TODO: caption — per-amp τ_nw, τ_fw, Δτ across 1.3–1.6 Hz, mirrors ch05_damping_freq layout
...
Per amplitude tier (A1/A2/A3), tabulates τ at no-wind, τ at full-wind, and
Δτ across the four thesis frequencies. Three row-blocks mirror the three
stacked subfigures of ch05_damping_freq so the reader can read off the
plotted values without counting from a graph.
...
wind shifts τ from … to …" rather than "at 1.3 Hz, the three amplitudes …".
