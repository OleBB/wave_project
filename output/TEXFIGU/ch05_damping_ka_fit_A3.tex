...
%   data_class        : DELEG
%   generated_at      : 2026-05-07T17:25:37
%   findings_doc      : memory/methodology_wind_enhances_A_in.md
%
% — Thesis context ──────────────────────────────────────────────
%   chapter           : 05
%   caption_label     : fig:ch05_damping_ka_fit_A3
%   caption_short     : Transmisjon per ka, $A_3$ — med kurvetilpasning per vind.
%
% — Filters ────────────────────────────────────────────────────
%   panel             : full
%   wind              : no + full
...
%     FIGURES/ch05_damping_ka_fit_A3.pdf
% ── end immutable block ─────────────────────────────────────────
\begin{figure}[htbp]
  \centering
  \includegraphics[width=\linewidth]{FIGURES/ch05_damping_ka_fit_A3.pdf}
  \caption[Transmisjon per ka, $A_3$ — med kurvetilpasning per vind.]{
    TODO: skriv hovedteksten. Som figur \ref{fig:ch05_damping_ka_fit_A1}, men for $A_3$.
  }
  \label{fig:ch05_damping_ka_fit_A3}
\end{figure}
